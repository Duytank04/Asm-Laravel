                        ...
                        <div class="row align-items-center gy-3">
                            ...
                            <div class="col-sm-auto">
                                <div class="d-flex gap-1 flex-wrap">
                                    <a href="{{ route('admin.categories.create') }}" class="btn btn-success add-btn"
                                        id="create-btn"><i class="ri-add-line align-bottom me-1"></i>Thêm mới thể loại</a>
                                </div>
                            </div>
                        </div>
                    </div>
                                ...
                                <table class="table table-nowrap align-middle" id="orderTable">
                                    <thead class="text-muted table-light">
                                        <tr class="text-uppercase">
                                            ...
                                            <th data-sort="customer_name">Tên thể loại</th>
                                            <th data-sort="product_name">Ảnh thể loại</th>
